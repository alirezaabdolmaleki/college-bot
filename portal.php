		...
		<div class="col-lg-8 <?php echo isMobileDevice() == false ?  "offset-2" : '' ?>">
			<div class="card direct-chat direct-chat-primary" id="chat_convo">
				<div class="card-header ui-sortable-handle" style="cursor: move;">
					<h3 class="card-title">از من بپرس</h3>
				...
				<div class="card-footer">
					<form id="send_chat" method="post">
						<div class="input-group">
							...
							<textarea type="text" name="message" placeholder="...پیام خود را وارد کنید" class="form-control t-right round" required=""></textarea>

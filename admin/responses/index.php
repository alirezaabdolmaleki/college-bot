...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">فهرست پاسخ سوالات</h3>
		<div class="card-tools">
			<a href="?page=responses/manage" class="btn btn-flat btn-info"><span class="fas fa-plus"></span>  جدید</a>
		</div>
	</div>
	<div class="card-body">
		<div class="container-fluid">
			<table class="table table-bordered table-stripped text-right" dir="rtl">
				<colgroup>
					<col width="5%">
					<col width="20%">
					<col width="60%">
							...
							<td class=" text-center">
								 <button type="button" class="btn btn-flat btn-info dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu text-center" role="menu">
				                    <a class="dropdown-item" href="?page=responses/manage&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> ویرایش</a>

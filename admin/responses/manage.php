...
?>
<div class="card card-outline card-info text-right">
	<div class="card-header">
		<h3 class="card-title text-right"><?php echo isset($_GET['id']) ? "ویرایش ": "ساخت جدید " ?>سوال و پاسخ</h3>
	</div>
	<div class="card-body">
		<form action="" id="response-form">
			...
			<div class="form-group">
				<label for="question_field" class="control-label">سوال</label>
                ...
                <small><i>(برای اضافه کردن پاسخ بر روی  "<b>+</b>" کلیک کنید)</i></small>
			</div>
			<?php else: ?>
				<div class="form-group">
					<label for="question_field" class="control-label">سوال</label>
			...
			<div class="form-group">
				<label for="response_message" class="control-label">پیام خروجی</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="response-form">ذخیره</button>
		<a class="btn btn-flat btn-default" href="?page=responses">انصراف</a>
	</div>
</div>
<script>
	$(document).ready(function(){
